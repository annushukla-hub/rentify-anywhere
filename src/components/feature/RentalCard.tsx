        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="mt-auto flex items-center justify-between pt-4 border-t">
            ...
            <div className="flex items-center gap-4">
              ...
              <button className="px-6 py-2 bg-gradient-primary text-primary-foreground rounded-lg hover:opacity-90 transition-opacity font-medium shadow-md">
                Book Now
              </button>
            </div>
          </div>
    ...
    <div className="group rounded-2xl border bg-card overflow-hidden hover:shadow-xl transition-all duration-300 animate-fade-in">
      ...
      <div className="p-5">
        ...
        <div className="flex items-center justify-between pt-4 border-t">
          ...
          <button className="px-5 py-2 bg-gradient-primary text-primary-foreground rounded-lg hover:opacity-90 transition-opacity font-medium text-sm shadow-md">
            Book
          </button>
        </div>
      </div>
